  ...
  return (
    <div className="container mx-auto p-6">
      <div className="max-w-lg mx-auto text-center space-y-4">
        <h1 className="text-2xl font-bold text-foreground">Fuel Dashboard Unavailable</h1>
        <p className="text-muted-foreground">
          {error.message || 'Failed to load fuel data. The fuel record tables may not be initialized yet.'}
        </p>
        {error.digest && (
