 ...
 */
export async function getFleetFuelSummary(daysBack: number = 30) {
 ...
 */
export async function getFuelEfficiencyTrend(daysBack: number = 30) {
  await requireRole([UserRole.OWNER, UserRole.MANAGER]);
 ...
 */
export async function getCO2Emissions(daysBack: number = 30) {
  await requireRole([UserRole.OWNER, UserRole.MANAGER]);
 ...
 */
export async function getIdleTimeAnalysis(daysBack: number = 30) {
  await requireRole([UserRole.OWNER, UserRole.MANAGER]);
 ...
 */
export async function getFuelEfficiencyRankings(daysBack: number = 30) {
  await requireRole([UserRole.OWNER, UserRole.MANAGER]);
