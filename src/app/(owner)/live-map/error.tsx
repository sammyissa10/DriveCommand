...
export default function LiveMapError({
  error,
  reset,
}: {
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="max-w-lg mx-auto text-center space-y-4">
        <h1 className="text-2xl font-bold text-foreground">Live Map Unavailable</h1>
        <p className="text-muted-foreground">
          {error.message || 'Failed to load the live fleet map. The GPS data tables may not be initialized yet.'}
        </p>
        {error.digest && (
