...
interface DocumentExpiryReminderEmailProps {
  truckName: string;
...
export function DocumentExpiryReminderEmail({
  truckName,
  documentType,
  expiryDate,
  daysUntilExpiry,
  dashboardUrl,
}: DocumentExpiryReminderEmailProps) {
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Section style={styles.header}>
            <Text style={styles.headerText}>Document Expiry Notice</Text>
          </Section>
          ...
          <Section style={styles.content}>
            ...
            <Text style={styles.message}>
              {isExpired
                ? 'A required document has expired for your truck:'
                : `A required document is expiring soon for your truck:`}
            </Text>
            ...
            <Section style={styles.card}>
              ...
              {isUrgent && (
                <Text style={styles.warning}>
                  {isExpired
                    ? 'Please renew this document immediately to maintain compliance.'
                    : 'Please renew this document soon to avoid expiration.'}
                </Text>
              )}
            </Section>
          ...
          <Section style={styles.footer}>
            ...
            <Text style={styles.footerSubtext}>
              This is an automated reminder. Please log in to update your documents.
            </Text>
          </Section>
        </Container>
      </Body>
