/**
 * quick-625 — staging preconditions (copy of 624's; evidence path changed only), measured before anything is changed.
 *
...
const EVIDENCE_DIR = resolve(
  REPO_ROOT,
  '.planning/quick/625-checkout-guc-reassertion-vs-per-unit-bin/evidence',
);
