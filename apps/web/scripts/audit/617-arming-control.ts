...
const EV = resolve(APP_ROOT, '../../.planning/quick/617-route-the-mobile-api-surface-to-gettenan/evidence');
...
(async () => {
  ...
  say('');
  say('quick-617 — arming counter-assertion, four parts');
  say('================================================');
  ...
  writeFileSync(resolve(EV, '05-arming-control.txt'), lines.join('\n') + '\n');
