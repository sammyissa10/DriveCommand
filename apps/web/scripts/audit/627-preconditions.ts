/**
 * quick-627 — staging preconditions (copy of 626's; evidence path changed only), measured before anything is changed.
 *
...
const EVIDENCE_DIR = resolve(
  REPO_ROOT,
  '.planning/quick/627-adopt-checkout-guc-re-assertion-leave-mo/evidence',
);
