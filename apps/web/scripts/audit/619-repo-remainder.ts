/**
 * quick-619 — THE REPO-WIDE `app.bypass_rls` REMAINDER, MEASURED.
 *
 *   npx tsx scripts/audit/619-repo-remainder.ts [--after]
 *
...
function main() {
  ...
  // quick-619: the counter-assertion target is a file THIS task routed (8 of the 33).
  const cPath = 'src/lib/geofencing/geofence-check.ts';
  ...
  const EXPECTED = 92 - 33;
  checks.push({
    name: 'ARITHMETIC — 92 at quick-619 start − 33 routed from LIB_SERVICES = 59',
  ...
  const out = {
    ...
    arithmetic: {
      ...
      routedBy616: 2,
      liveAt617Start: 175,
      routedBy617: 67, liveAt618Start: 108, routedBy618: 16, liveAt619Start: 92, routedBy619: 33,
