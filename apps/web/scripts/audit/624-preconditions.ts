/**
 * quick-624 — staging preconditions (copy of 623's; evidence path changed only), measured before anything is changed.
 *
...
const EVIDENCE_DIR = resolve(
  REPO_ROOT,
  '.planning/quick/624-explain-the-home-tc001-raise-on-a-scoped/evidence',
);
