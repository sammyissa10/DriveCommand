...
const EV = resolve(APP_ROOT, '../../.planning/quick/623-fix-seedstarterplaybooks-tenant-scoping-/evidence');
...
(async () => {
  ...
  say('');
  say('quick-623 — arming counter-assertion, four parts (copy of 621-arming-control.ts, evidence path changed)');
  say('================================================');
