...
const EV = resolve(APP_ROOT, '../../.planning/quick/621-sweep-layouts-templates-middleware-provi/evidence');
...
(async () => {
  ...
  say('');
  say('quick-621 — arming counter-assertion, four parts (copy of 617-arming-control.ts, evidence path changed)');
  say('================================================');
