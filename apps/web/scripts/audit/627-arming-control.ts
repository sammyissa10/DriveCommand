...
const EV = resolve(APP_ROOT, '../../.planning/quick/627-adopt-checkout-guc-re-assertion-leave-mo/evidence');
...
(async () => {
  ...
  say('');
  say('quick-627 — arming counter-assertion, four parts (copy of 624-arming-control.ts, evidence path changed)');
  say('================================================');
  ...
  writeFileSync(resolve(EV, '06-arming-control.txt'), lines.join('\n') + '\n');
