...
const EV = resolve(APP_ROOT, '../../.planning/quick/620-route-the-api-v1-surface/evidence');
...
(async () => {
  ...
  say('');
  say('quick-620 — arming counter-assertion, four parts (copy of 617-arming-control.ts, evidence path changed)');
  say('================================================');
