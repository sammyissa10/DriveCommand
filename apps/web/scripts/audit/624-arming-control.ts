...
const EV = resolve(APP_ROOT, '../../.planning/quick/624-explain-the-home-tc001-raise-on-a-scoped/evidence');
...
(async () => {
  ...
  say('');
  say('quick-624 — arming counter-assertion, four parts (copy of 623-arming-control.ts, evidence path changed)');
  say('================================================');
