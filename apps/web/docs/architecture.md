...
2. **Unauthenticated requests are redirected.** If no valid Supabase session cookie exists, the user is redirected to `/sign-in?redirect_url=<original path>`.
