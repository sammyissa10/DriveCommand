      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.content}>
            <Text style={styles.greeting}>Stop Completed</Text>
            <Text style={styles.message}>
              A driver has completed a stop. Review the details below.
            </Text>
            ...
            <Section style={styles.detailsBox}>
              ...
              <Text style={styles.detailRow}>
                <strong>Stop Type:</strong> {stopTypeLabel}
              </Text>
              <Text style={styles.detailRow}>
                <strong>Facility:</strong> {facilityName}
              </Text>
              <Text style={styles.detailRow}>
                <strong>Completed At:</strong> {completionTime}
              </Text>
              <Text style={styles.detailRow}>
                <strong>Dispatch:</strong> {dispatchNumber}
              </Text>
            </Section>

            <Section style={styles.ctaSection}>
              <Button href={dispatchDetailUrl} style={styles.button}>
                View Dispatch
              </Button>
            </Section>
          </Section>
