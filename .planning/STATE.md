...
Last activity: 2026-07-18 - Completed quick task 471: Route Financial Summary now auto-includes linked (non-cancelled) load rates in Total Revenue, with a "Includes $X from N linked loads" line and pending = total − paid; so carrier load revenue reflects without double-entering manual Payment records.
