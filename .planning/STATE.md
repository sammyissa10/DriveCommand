...
Last activity: 2026-07-18 - Completed quick task 472: Trip Stops now support a per-stop Load association — "For Load" picker on Add Stop and Edit Stop dialogs, Load badge on stop cards (desktop + mobile), backend PATCH accepts/persists loadId with org-ownership verification.
