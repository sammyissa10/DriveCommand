...
Last activity: 2026-06-17 - Completed quick task 465: Renamed "Dispatch immediately" toggle label to "Add to Trip immediately" in LoadForm.tsx; replaced raw DRIVER_NOT_DISPATCH_READY error code with human-readable onboarding guidance toast (6000ms) and generic fallback for other dispatch errors.
