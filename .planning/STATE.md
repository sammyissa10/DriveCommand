...
Last activity: 2026-07-17 - Completed quick task 470: Wired Routes create/edit Truck dropdown to the carrier fleet (CarrierTruck) via a new nullable Route.carrierTruckId FK — dropdown was previously reading the empty legacy Truck table, blocking route creation entirely.
