...
Last activity: 2026-07-18 - Completed quick task 475: Full mobile-ds rebuild of the New Route form (RouteCreateMobile — kept address autocomplete, live OSRM distance, multi-stop editor, driver/co-driver/carrier-truck pickers; submits via useActionState(createRoute) with the exact FormData contract incl. carrierTruckId) and repointed the New Dispatch Quick Create item to /carrier/trips/new. ALL Quick Create menu destinations are now on the mobile design system.
