# quick-608 · 01 — the ledger at OPEN

Taken 2026-09-15T21:05:15.376Z. Production is read **read-only**, with every statement drawn from
...
|---|---|---|---|
| `_prisma_migrations` rows | **159** | 156 | MISMATCH |
| `pg_policy` in `public` | **183** | 183 | MATCH |
| newest `migration_name` | `20260915130000_grant_playbook_notification_to_app_admin` | `20260914170000_activation_progress_congrats_shown_at` | MISMATCH |
...
- **FAILED:** production _prisma_migrations = 159, expected 156
- **FAILED:** production head migration = 20260915130000_grant_playbook_notification_to_app_admin, expected 20260914170000_activation_progress_congrats_shown_at
