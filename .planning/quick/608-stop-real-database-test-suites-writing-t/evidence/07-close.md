# quick-608 · 07 — the ledger at CLOSE

Taken 2026-09-15T21:05:58.810Z.

## Production — `oqdhberkghtnszrkdvfm`, open vs close

| reading | at open | at close | verdict |
|---|---|---|---|
| production _prisma_migrations rows | `159` | `159` | **MISMATCH** |
| production pg_policy(public) | `183` | `183` | **identical** |
| production newest migration_name | `20260915130000_grant_playbook_notification_to_app_admin` | `20260915130000_grant_playbook_notification_to_app_admin` | **MISMATCH** |
| production "Tenant" row count | `31` | `32` | **MISMATCH** |
| production throwaway-named tenants (ZZ-/FI-Test/MT-Test) | `9` | `9` | **identical** |
...
**PRODUCTION BASELINE MOVED — see the mismatches above.**
