# quick-597 — RLS policy verification matrix (AFTER)

- Captured: 2026-09-14T04:35:33.138Z
...
| `in_app_notifications.insert-cross@guc-A` | ERROR [42501] new row violates row-level security policy for table "in_app_notifications" |
