...
Generated 2026-09-15T19:05:38.207Z. Membership is read from `scripts/audit/wrapper-countdown.json`
...
| `/api/cron/carrier-auto-dispatch` | surface | 500 | `TC001` | **TRIPWIRE_TC001** | SQLSTATE is TC001 | `src/app/api/cron/carrier-auto-dispatch/route.ts:52` (`GET`) | **OUTSIDE_456** |
...
| `/api/cron/trip-reminders` | surface | 200 | — | **SOMETHING_ELSE** | no SQLSTATE recovered | — | **SITE_UNRECOVERED** |
...
| `/api/cron/carrier-auto-dispatch` | `src/app/api/cron/carrier-auto-dispatch/route.ts` | 52 | `GET` | TRIPWIRE_TC001 |
